"""
Django settings for FairKeep project.
"""
import os
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-zcfd^r2wz4a95&$1r%#@4i+v$c4v=o174l%v&=0%o*y6#hvdax')
...
WSGI_APPLICATION = 'fairkeep.wsgi.application'
...
if extra_cors:
    default_cors.extend([x.strip() for x in extra_cors.split(',') if x.strip()])
